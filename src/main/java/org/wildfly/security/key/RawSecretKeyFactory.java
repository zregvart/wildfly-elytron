...
public final class RawSecretKeyFactory extends SecretKeyFactorySpi {
    ...
    protected SecretKey engineGenerateSecret(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        throw new InvalidKeySpecException("keySpec must be SecretKeySpect, given: " + keySpec.getClass().getName());
    }
    ...
    protected KeySpec engineGetKeySpec(SecretKey key, Class<?> keySpec) throws InvalidKeySpecException {
        ...
        throw new InvalidKeySpecException(
                "key must implement SecretKeySpec and keySpec must be SecretKeySpect, given: " + keySpec.getName());
    }
